 ...
 *   <li>Voucher:        none.</li>
 *   <li><b>Same-day/past screening: £0 refund (overrides the 70% rule).</b></li>
 * </ul>
 * <p>
 * VIP退款策略 — 为VIP会员提供的优惠规则集。
 * <p>
 * 规则（任务9）：
 * <ul>
 *   <li>电影票：原始票价的70%退款（比 {@link StandardPolicy} 高20个百分点）。</li>
 *   <li>食品/饮料：100%退款。</li>
 *   <li>VIP套餐：100%退款（仅在包含此项目时）。</li>
 *   <li>优惠券：无。</li>
 *   <li><b>同日/已放映场次：0元退款（覆盖70%规则）。</b></li>
 * </ul>
...
public class VIPPolicy implements CancellationPolicy {
    ...
    public PolicyRefundResult calculate(RefundContext context) {
        ...
        // This rule overrides the VIP 70% refund rate.
        // 此规则覆盖VIP的70%退款率。
        ...
        // Movie ticket refund: 0% for same-day/past, 70% for future screenings
        // 电影票退款：同日/已放映为0%，未来场次为70%
